...
public class body_store_fragment2_1 extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		view = inflater.inflate(R.layout.body_store__fragment2_1, null);
		this.menu_listview1 = (ListView) view.findViewById(R.id.menu_listview1);
	...
	class MyBaseAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			listitemview.dishName_mune.setText((String) list.get(position).get(
					"dishName"));
			listitemview.price_mune.setText((String) list.get(position).get(
					"price"));
			...
			plus.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Num = a + "";
					/**
					 * 首先判断 myapp.maps是否含有同名的商品信息 若是同名的 从map中读取当前的总个数和当前总价格
					...
					addText.setText(a + "");
					setText(position, 1 + "", list.get(position).get("price")
							.toString());
	...
	public void setText(int index, String a, String price) {
		...
		MyApp.map2.put(list.get(index).get("dishName").toString(),
				list.get(index).get("price").toString());
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			list = (List<Map<String, Object>>) msg.obj;//从数据库获取数据
	...
	Runnable runnable = new Runnable() {
		@Override
		public void run() {
			List<Map<String, Object>> aa = bo.QuerydishbyType(MyApp.rice,
					MyApp.businessid);
